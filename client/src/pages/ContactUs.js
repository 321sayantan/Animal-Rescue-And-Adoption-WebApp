        ...
        <div className="w3l-breadcrumb py-lg-5" data-aos="fade-up">
          <div className="container pt-4 pb-sm-4">
            ...
            <ul className="breadcrumbs-custom-path">
              ...
              <li className="active"><i className="fas fa-angle-right mx-2" />Contact</li>
            </ul>
          </div>
        </div>
        <div className="shape">
      ...
      <div className="w3l-contact-info pt-5" id="contact">
        <div className="container py-md-5 py-4">
          ...
          <div className="align-self pt-4">
            <div className="contact-infos">
              <div className="single-contact-infos" data-aos="fade-down">
                <div className="icon-box"><i className="fas fa-map-marker-alt color-1" /></div>
              ...
              <div className="single-contact-infos" data-aos="fade-down">
                <div className="icon-box"><i className="fas fa-clock color-2" /></div>
                <div className="text-box">
              ...
              <div className="single-contact-infos" data-aos="fade-down">
                <div className="icon-box"><i className="fas fa-envelope-open-text color-3" /></div>
                <div className="text-box">
          ...
          <div className="row mt-5 pt-md-5">
            <div className="col-lg-6 map order-lg-1 order-2" data-aos="fade-right">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3001161.424489281!2d-78.01909140705047!3d42.72866436845163!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4ccc4bf0f123a5a9%3A0xddcfc6c1de189567!2sNew%20York%2C%20USA!5e0!3m2!1sen!2sin!4v1570786994395!5m2!1sen!2sin" title='store-location' frameBorder={0} allowFullScreen />
            </div>
            <div className="col-lg-6 form-inner-cont order-lg-2 order-1 mb-lg-0 mb-5 ps-lg-4" data-aos="fade-left">
              <form action="https://sendmail.w3layouts.com/submitForm" method="post" className="signin-form">
                ...
                <div className="form-input">
                  <textarea name="w3lMessage" id="w3lMessage" placeholder="Your message" required defaultValue={""} />
                </div>
